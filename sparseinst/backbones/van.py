...
class VAN(Backbone):
    def __init__(self, img_size=224, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
        ...
        # output feature shape for encoder
        out_features_names = ["Hd8", "Hd16", "Hd32"]  # table 5 in VAN H/n*H/n, remove H/4
        self._out_feature_channels = dict(zip(out_features_names,[128,320,512]))
    ...
    def forward(self, x):
        ...
        outs = dict(zip(self._out_features, x))
...
def van_b1(cfg, input_shape=None, pretrained=True, **kwargs):
    model = VAN(
